...
Mouser.prototype.realize = function () {
    if (this.svgNode == null) {
        ...
        this.svgNode = rect;
        rect.setAttributeNS(null, "x", "-32767");
        rect.setAttributeNS(null, "y", "-32767");
        rect.setAttributeNS(null, "width", "65535");
        rect.setAttributeNS(null, "height", "65535");
        ...
        if ((index + param_length) < tokens.length) {
            ...
            switch (mode) {
                ...
                case "z":
                    segment = new RelativeClosePath(params, this, previous);
                    break;
                default: throw new Error("Unsupported segment type: " + mode);
            }
            ;
