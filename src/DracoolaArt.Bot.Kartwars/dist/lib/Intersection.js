...
Intersection.intersectBezier2Bezier3 = function (a1, a2, a3, b1, b2, b3, b4) {
    ...
    var poly = new Polynomial(-2 * c12.x * c12.y * c23.x * c23.y + c12x2 * c23y2 + c12y2 * c23x2, -2 * c12.x * c12.y * c22.x * c23.y - 2 * c12.x * c12.y * c22.y * c23.x + 2 * c12y2 * c22.x * c23.x +
...
Intersection.intersectBezier2Ellipse = function (p1, p2, p3, ec, rx, ry) {
    ...
    var rxrx = rx * rx;
    var ryry = ry * ry;
    var roots = new Polynomial(ryry * c2.x * c2.x + rxrx * c2.y * c2.y, 2 * (ryry * c2.x * c1.x + rxrx * c2.y * c1.y), ryry * (2 * c2.x * c0.x + c1.x * c1.x) + rxrx * (2 * c2.y * c0.y + c1.y * c1.y) -
...
Intersection.intersectBezier3Bezier3 = function (a1, a2, a3, a4, b1, b2, b3, b4) {
    ...
    var poly = new Polynomial(-c13x3 * c23y3 + c13y3 * c23x3 - 3 * c13.x * c13y2 * c23x2 * c23.y +
...
Intersection.intersectBezier3Ellipse = function (p1, p2, p3, p4, ec, rx, ry) {
    ...
    var rxrx = rx * rx;
    var ryry = ry * ry;
    var poly = new Polynomial(c3.x * c3.x * ryry + c3.y * c3.y * rxrx, 2 * (c3.x * c2.x * ryry + c3.y * c2.y * rxrx), 2 * (c3.x * c1.x * ryry + c3.y * c1.y * rxrx) + c2.x * c2.x * ryry + c2.y * c2.y * rxrx, 2 * c3.x * ryry * (c0.x - ec.x) + 2 * c3.y * rxrx * (c0.y - ec.y) +
...
Intersection.intersectEllipseEllipse = function (c1, rx1, ry1, c2, rx2, ry2) {
    ...
    for (var y = 0; y < yRoots.length; y++) {
        ...
        for (var x = 0; x < xRoots.length; x++) {
            var test = (a[0] * xRoots[x] + a[1] * yRoots[y] + a[3]) * xRoots[x] +
